  ...
  row.innerHTML = `
    <div class="flex gap-3 items-start">
      <div class="flex-1 flex flex-col gap-2">
        <input type="text" class="row-text-input input-field w-full h-10 rounded-lg text-white text-sm px-3" placeholder="Enter text..." style="background-color: var(--void); border-color: rgba(138, 168, 168, 0.2);"/>
